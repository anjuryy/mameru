...
import {
  mergeVertices
} from "./chunk-6NGPXAA4.js";
import {
  useFrame
} from "./chunk-N3OWSJZB.js";
import {
  BufferAttribute,
  DynamicDrawUsage,
  Euler,
...
var Physics = ({
  ...
  useFrame((_, dt) => {
    ...
    const interpolationAlpha = timeStepVariable ? 1 : steppingState.accumulator % _timeStep / _timeStep;
    ...
    eventQueue.drainCollisionEvents((handle1, handle2, started) => {
      ...
      const rigidBody1 = rigidBodyHandle1 ? world.getRigidBody(rigidBodyHandle1) : void 0;
      const rigidBody2 = rigidBodyHandle2 ? world.getRigidBody(rigidBodyHandle2) : void 0;
      const rigidBody1Events = rigidBodyHandle1 ? rigidBodyEvents.get(rigidBodyHandle1) : void 0;
      const rigidBody2Events = rigidBodyHandle2 ? rigidBodyEvents.get(rigidBodyHandle2) : void 0;
      const collider1State = colliderStates.get(collider1.handle);
      const collider2State = colliderStates.get(collider2.handle);
      const rigidBody1State = rigidBodyHandle1 ? rigidBodyStates.get(rigidBodyHandle1) : void 0;
      const rigidBody2State = rigidBodyHandle2 ? rigidBodyStates.get(rigidBodyHandle2) : void 0;
      if (started) {

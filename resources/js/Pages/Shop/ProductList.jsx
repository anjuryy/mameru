                    ...
                    filteredData.slice(0, 15).map((value, index) => {
                        return (
                            ...
                            <div >
                                ...
                                <p className="text-sm font-medium text-gray-900">{ userCurrencySetting[0]['currency_converters'].symbol }{Math.floor(parseInt(value.price) * userCurrencySetting[0]['currency_converters'].value)}</p>
                                </div>
                            </div>
                            </Box>
                        )

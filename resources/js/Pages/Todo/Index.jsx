            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-end">
                        <Link href={route('todo.create')} className="bg-gray-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mr-4 mb-4 rounded-full focus:outline-none focus:shadow-outline">
                    ...
                    <ul role="list" className="divide-y divide-gray-100">
                        ...
                        <Pagination todoData={ todo_list.links } todoLength={ todo_list }/>
                    </div>
                </div>
